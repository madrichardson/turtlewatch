...
document.addEventListener("DOMContentLoaded", function() {
  ...
  // === Load ENSO + SST JSON instead of CSV ===
  ...
  function renderTable(year, unit) {
    ...
    // iterate over keys t0..t5 in latest.json
    Object.keys(allData).forEach(key => {
      ...
      // ENSO status + forecast come from ensoData
  ...
  function updateBycatch(year) {
    ...
    if (bycatchImg)
      bycatchImg.src = `data/images/indicator_${year}.png`;
  }
  // === SST & Anomaly Cards ===
  function updateSST() {
